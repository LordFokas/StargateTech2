...
public class RenderBlockMachineBAD extends BaseISBRH {
	private static final RenderBlockMachineBAD INSTANCE = new RenderBlockMachineBAD();
	
	public static RenderBlockMachineBAD instance(){
		return INSTANCE;
	}
	
	@Override
	public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer){
		BlockMachineBAD machine = (BlockMachineBAD) block;
		int direction = -1;
