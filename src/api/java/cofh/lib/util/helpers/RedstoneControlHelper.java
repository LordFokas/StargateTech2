...
public final class RedstoneControlHelper {
	...
	public static boolean hasRSControl(ItemStack stack) {
		...
		return !stack.hasTagCompound() ? false : stack.getTagCompound().hasKey("RSControl");
	}
	...
	public static ControlMode getControl(ItemStack stack) {
		...
		return !stack.hasTagCompound() ? ControlMode.DISABLED : ControlMode.values()[stack.getTagCompound().getByte("RSControl")];
	}
