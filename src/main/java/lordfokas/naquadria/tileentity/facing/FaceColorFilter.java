...
public abstract class FaceColorFilter implements IFilter<FaceColor>{
	public static final FaceColorFilter INPUT = new FaceColorFilter(){
		@Override public boolean matches(FaceColor color) {
	...
	public static class MatchColors extends FaceColorFilter{
		...
		@Override
		public boolean matches(FaceColor color) {
